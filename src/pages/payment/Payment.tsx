        ...
        <PaymentContainer>
            <div className="container">
                ...
                <div className="price-info">
                    <PaymentBlock type="PRO" price="28,000" use={true} items={["매물 미래 가격 확인", "보고서 인쇄", "인공지능 매물 추천 (정식)"]}/>
                    <PaymentBlock type="ENTERPRISE" price="58,000" use={false} items={["매물 미래 가격 확인", "보고서 인쇄", "인공지능 매물 추천 (정식)"]}/>
                </div>
            </div>
        </PaymentContainer>
    )
